...
output at **R² 0.957** and independently re-finds every known fault (01.08.053 → HI 0.34,
01.03.018 → HI 0.88).
...
**real ~7–10% plant-wide gap** vs the commissioned baseline (degradation + soiling + possible
...
- **Relative method — now backed by an absolute twin.** The peer ratio measures inverters
  ...
  twin drops to 0.81 (detected). It also surfaces a real ~7–10% plant-wide gap the peer
  method cannot see. Details + proof: [`runs/plant_a/twin/TWIN.md`](runs/plant_a/twin/TWIN.md).
