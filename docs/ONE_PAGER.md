...
| 2 | ACTIVE collapse, sections 01.08+01.09 (since Aug 2025) | inverters at 0.35–0.50 of peers; 740–840 outage h/365d each | ~€1,200/yr realized; **€42,325/yr at risk** (368 kWp) |
...
| 5 | Alarm triage: 9,211 events → 823 incidents | 25% TRIP / 4% DERATE / 71% NUISANCE; ENS costliest | 1.4 of 2.6 MWh lost energy from one code family |
...
Repo: README + `runs/` contain every chart and CSV behind the numbers above; analysis is
reproducible with `src/twin/run_plant_a.py` / `run_plant_b.py`.
